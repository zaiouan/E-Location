    ...
    <form method="post" action="{{route('finances.update',$finance)}}">
        ...
        <div class="mr-64">
            ...
            <div class="md:flex mb-6">
                ...
                <div class="md:w-2/3">
                    <input class="form-input block w-full focus:bg-white @error('loyer') border-red-500 @enderror" id="my-textfield" type="number"  name="loyer" value="{{$finance->montant}}">
                    @error('loyer')
                    <p class="text-red-500 text-xs italic mt-4">
                        {{ $message }}
                    </p>
            ...
            <div class="md:flex mb-6">
                ...
                <div class="md:w-2/3">
                    <input class="form-input block w-full focus:bg-white @error('Tva') border-red-500 @enderror" step="0.01" id="my-textfield" type="number"  name="TVA" value="{{$finance->TVA}}">
                    @error('TVA')
                    <p class="text-red-500 text-xs italic mt-4">
                        {{ $message }}
                    </p>
