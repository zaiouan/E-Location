            ...
            @foreach($messages as $msg)
                ...
                <tr>
                    ...
                    <td><a class="bg-blue-500 text-white rounded-lg p-1 font-bold text-sm hover:bg-green-600 hover:text-white"
                           @if($msg->message=='') href="{{route('show',$msg->id)}}" @else href="{{route('show3',$msg->id)}}" @endif "><i class="edit icon text-sm"></i><span class="ml-1">Afficher</span></a>
